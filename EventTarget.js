...
function getListenersOptions (listeners, type, options) {
    ...
    const listenersByTypeOptions = listenersByType.filter(function (obj) {
...
Object.assign(EventTarget.prototype, {
    ...
    invokeCurrentListeners: function (listeners, eventCopy, type, checkOnListeners) {
        ...
        listenersByType.some((listenerObj, i) => {
            ...
            const once = options.once; // Remove listener after invoking once
            const passive = options.passive; // Don't allow `preventDefault`
            const capture = options.capture; // Use `_children` and set `eventPhase`
...
export {ShimEvent, ShimCustomEvent, ShimDOMException, EventTarget as ShimEventTarget, EventTargetFactory};
