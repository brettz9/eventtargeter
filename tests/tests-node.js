    ...
    testTypesArr.forEach(function (evClass) {
        function newEvent (type, evInit) {
            return (evClass === 'nativeEvent'
                ...
                : new EventTarget$1.ShimEvent(type, evInit)); // This event will either be the native or, for Node, our exported shim
        }

        function Car () {}
        Car.prototype = EventTarget$1.EventTargetFactory.createInstance();
        ...
        CategoryTree.prototype = EventTarget$1.EventTargetFactory.createInstance();
            ...
            describe('dispatchEvent', function () {
                ...
                describe('Propagation (bubbling, capturing, and stopping propagation)', function () {
                    ...
                    it('should capture whether `capture` option stated as boolean or object property', function (done) {
                        ...
                        Object.setPrototypeOf(parent, EventTarget$1.EventTargetFactory.createInstance());
                        Object.setPrototypeOf(child, EventTarget$1.EventTargetFactory.createInstance());
                        let caught1 = false;
                    ...
                    it('should get proper target, currentTarget, and eventPhase event properties when set', function (done) {
                        ...
                        let caught2 = false;
                        let caught3 = false;
                        Object.setPrototypeOf(grandparent, EventTarget$1.EventTargetFactory.createInstance());
                        Object.setPrototypeOf(parent, EventTarget$1.EventTargetFactory.createInstance());
                        Object.setPrototypeOf(child, EventTarget$1.EventTargetFactory.createInstance());
